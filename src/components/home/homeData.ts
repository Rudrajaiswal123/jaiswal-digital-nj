...
export const faqs = [
  {
    ...
    answer: "Jaiswal Digital provides website development, SEO, local SEO, paid advertising, social media management, e-commerce marketplace support, graphic design and video creation. We help businesses choose and connect the digital work that supports their visibility, enquiries and online operations."
  },
  {
    question: "Do you provide digital marketing services across India?",
    answer: "Yes. We work with businesses across India through digital-first collaboration. Our offices are in Bengaluru, Karnataka, and Patna, Bihar."
  },
  {
    question: "Why choose Jaiswal Digital as your SEO company in India?",
    answer: "Our SEO work starts with the business, audience and pages that matter most. It can include keyword research, on-page improvements, technical SEO, local-search optimization and link-earning activity. Search results depend on competition and website condition, so we focus on sustainable improvements rather than ranking guarantees."
  },
  {
    question: "Do you offer Amazon seller account management services?",
    answer: "Yes. We support Amazon, Flipkart and Meesho sellers with marketplace account operations and product-listing optimization. Contact us with your marketplace and product requirements to discuss the appropriate scope."
  },
  {
