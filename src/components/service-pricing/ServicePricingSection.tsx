...
export default function ServicePricingSection({ services }: { services: ServicePrice[] }) {
  return <section className="service-pricing-section" aria-labelledby="service-pricing-title"><div className="service-pricing-container">
    ...
    <aside className="custom-pricing-banner"><div><h3>Need More Than One Service?</h3><p>Combine website development, SEO, advertising and social media into a customized digital growth solution for your business.</p><small>Flexible solutions <b>•</b> Transparent pricing <b>•</b> Customized strategy</small></div><Link href="/contact" className="custom-pricing-button">Get a Custom Quote <i className="bi bi-arrow-right" aria-hidden="true" /></Link></aside>
  </div></section>;
}
